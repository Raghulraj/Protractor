...
exports.run = async function(runner, specs) {
  ...
  // disable function is not available on Jasmine 3.* version
  // changing it back to spec.pend() function
  // See https://github.com/jasmine/jasmine/blob/main/lib/jasmine-core/jasmine.js#L846
